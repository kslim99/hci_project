...
let poolInputIDList = ["flower", "windflower", "line"];
...
// ----------model structure --------------
d3.select("#inception-9-img").on("mouseover", function () {
    let modelstructImg = document.getElementById("inception-9-img");
    ...
    plusPool.style.top = modelstructImgTop + modelstructImgHeight * 0.7 + "px";
    plusFC.style.top = modelstructImgTop + modelstructImgHeight * 0.8 + "px";

    plusConv.style.left = "62%";
    plusPool.style.left = "62%";
    plusFC.style.left = "62%";
...
// descriptions
d3.text("./description/GoogLeNet/ILSVRC.txt").then(function (text) {
    d3.select("#section-model-overview").select(".description").text(text);
});

d3.text("./description/GoogLeNet/input.txt").then(function (text) {
    d3.select("#section-input").select(".description").text(text);
});

d3.text("./description/GoogLeNet/ILSVRC.txt").then(function (text) {
    d3.select("#ilsvrc").text(text);
});

d3.text("./description/GoogLeNet/inception_9.txt").then(function (text) {
...
d3.text("./description/GoogLeNet/classifier.txt").then(function (text) {
    d3.select(".subsection.classifier").select(".description").text(text);
});

d3.text("./description/GoogLeNet/fc.txt").then(function (text) {
    d3.select(".subsection.fc").select(".description").text(text);
});

d3.text("./description/GoogLeNet/output.txt").then(function (text) {
